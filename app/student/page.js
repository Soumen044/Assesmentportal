        ...
        <section className="grid gap-2.5 lg:grid-cols-[0.98fr_1.02fr] fade-rise">
          <div className="card order-1 lg:order-2">
            <div className="flex flex-wrap items-center justify-between gap-2">
              ...
              <div className="badge-slate">Step {step} / 2</div>
            </div>
            <p className="mt-1 text-compact text-slate-500">
              {step === 1
                ? 'Session ID is checked before any student record is created.'
                : 'Password is confirmed before you enter the waiting room.'}
            </p>
            ...
            {step === 2 && (
              <div className="mt-3 compact-stack">
                <div className="glass-banner">
                  ...
                  <p className="mt-2 text-sm font-semibold text-slate-900">{sessionMeta?.name}</p>
                  <p className="mt-1 text-compact text-slate-500">ID: {sessionMeta?.sessionId} | {sessionMeta?.status}</p>
                </div>
                <div>
            ...
            <div className="card-strong">
              ...
              <div className="mt-3 grid gap-2 md:grid-cols-2">
                <div className="stat-card">
                  ...
                  <p className="mt-2 text-sm font-semibold">Profile and session check</p>
                </div>
                <div className="stat-card">
                  <p className="section-kicker">Step 2</p>
                  <p className="mt-2 text-sm font-semibold">Password check and room entry</p>
                </div>
              </div>
            </div>
